...
class WoodFeatures(models.Model):
    ...
    axial_parenchyma_arrangment1 = models.CharField("axial parenchyma arrangment1", max_length=50, blank=True)
    axial_parenchyma_arrangment2 = models.CharField("axial parenchyma arrangment2", max_length=50, blank=True)
    axial_parenchyma_arrangment3 = models.CharField("axial parenchyma arrangment3", max_length=50, blank=True)
    axial_parenchyma_arrangment4 = models.CharField("axial parenchyma arrangment4", max_length=50, blank=True)
    axial_parenchyma_arrangment5 = models.CharField("axial parenchyma arrangment5", max_length=50, blank=True)
    ...
    fibre_wall_thickeness = models.CharField("fibre wall thickeness", max_length=50, blank=True)
    ...
    intervessel_pit_arrangment = models.CharField("intervessel/tracheid pit arrangement", max_length=100, blank=True)
    intervessel_pit_size = models.CharField("intervessels pits size", max_length=100, blank=True)
    intervessel_pit_specific_shapes = models.CharField("Intervessel/tracheid pit shapes", max_length=100, blank=True)
    ...
    vessel_arrangment = models.CharField("vessel arrangment", max_length=50, blank=True)
