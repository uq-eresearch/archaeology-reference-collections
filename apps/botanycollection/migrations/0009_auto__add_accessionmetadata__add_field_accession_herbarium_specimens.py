...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccessionMetadata'
        db.create_table(u'botanycollection_accessionmetadata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True)),
            ('access', self.gf('django.db.models.fields.CharField')(default='private', max_length=10)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=120, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'botanycollection', ['AccessionMetadata'])

        # Adding field 'Accession.herbarium_specimens'
        db.add_column(u'botanycollection_accession', 'herbarium_specimens',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AccessionMetadata'
        db.delete_table(u'botanycollection_accessionmetadata')

        # Deleting field 'Accession.herbarium_specimens'
        db.delete_column(u'botanycollection_accession', 'herbarium_specimens')
