...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SeedFeatures.breadth'
        db.add_column(u'botanycollection_seedfeatures', 'breadth',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SeedFeatures.breadth'
        db.delete_column(u'botanycollection_seedfeatures', 'breadth')
    ...
    models = {
        ...
        u'botanycollection.seedfeatures': {
            ...
            'breadth': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
