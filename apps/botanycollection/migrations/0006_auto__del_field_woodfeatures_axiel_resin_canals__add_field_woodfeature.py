...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WoodFeatures.axial_resin_canals'
        db.add_column(u'botanycollection_woodfeatures', 'axial_resin_canals',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'WoodFeatures.epithelial_cells'
        db.add_column(u'botanycollection_woodfeatures', 'epithelial_cells',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'WoodFeatures.axial_tracheid_pits'
        db.add_column(u'botanycollection_woodfeatures', 'axial_tracheid_pits',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'WoodFeatures.spiral_thickenings'
        db.add_column(u'botanycollection_woodfeatures', 'spiral_thickenings',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'WoodFeatures.crassulae'
        db.add_column(u'botanycollection_woodfeatures', 'crassulae',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'WoodFeatures.nodular_tangential_ray_walls'
        db.add_column(u'botanycollection_woodfeatures', 'nodular_tangential_ray_walls',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'WoodFeatures.early_wood_ray_pits'
        db.add_column(u'botanycollection_woodfeatures', 'early_wood_ray_pits',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'WoodFeatures.late_wood_ray_pits'
        db.add_column(u'botanycollection_woodfeatures', 'late_wood_ray_pits',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WoodFeatures.axial_resin_canals'
        db.delete_column(u'botanycollection_woodfeatures', 'axial_resin_canals')

        # Deleting field 'WoodFeatures.epithelial_cells'
        db.delete_column(u'botanycollection_woodfeatures', 'epithelial_cells')

        # Deleting field 'WoodFeatures.axial_tracheid_pits'
        db.delete_column(u'botanycollection_woodfeatures', 'axial_tracheid_pits')

        # Deleting field 'WoodFeatures.spiral_thickenings'
        db.delete_column(u'botanycollection_woodfeatures', 'spiral_thickenings')

        # Deleting field 'WoodFeatures.crassulae'
        db.delete_column(u'botanycollection_woodfeatures', 'crassulae')

        # Deleting field 'WoodFeatures.nodular_tangential_ray_walls'
        db.delete_column(u'botanycollection_woodfeatures', 'nodular_tangential_ray_walls')

        # Deleting field 'WoodFeatures.early_wood_ray_pits'
        db.delete_column(u'botanycollection_woodfeatures', 'early_wood_ray_pits')

        # Deleting field 'WoodFeatures.late_wood_ray_pits'
        db.delete_column(u'botanycollection_woodfeatures', 'late_wood_ray_pits')
