...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WoodFeatures.fibre_wall_thickness'
        db.add_column(u'botanycollection_woodfeatures', 'fibre_wall_thickness',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'WoodFeatures.intervessel_tracheid_pit_shapes'
        db.add_column(u'botanycollection_woodfeatures', 'intervessel_tracheid_pit_shapes',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WoodFeatures.fibre_wall_thickness'
        db.delete_column(u'botanycollection_woodfeatures', 'fibre_wall_thickness')

        # Deleting field 'WoodFeatures.intervessel_tracheid_pit_shapes'
        db.delete_column(u'botanycollection_woodfeatures', 'intervessel_tracheid_pit_shapes')
