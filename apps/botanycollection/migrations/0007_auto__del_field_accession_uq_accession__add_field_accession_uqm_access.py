...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Accession.uq_accession'
        db.delete_column(u'botanycollection_accession', 'uq_accession')

        # Adding field 'Accession.uqm_accession'
        db.add_column(u'botanycollection_accession', 'uqm_accession',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=14, blank=True),
                      keep_default=False)

        # Adding field 'Accession.unique_identifier'
        db.add_column(u'botanycollection_accession', 'unique_identifier',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=24, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Accession.uq_accession'
        db.add_column(u'botanycollection_accession', 'uq_accession',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=14, unique=True, blank=True),
                      keep_default=False)

        # Deleting field 'Accession.uqm_accession'
        db.delete_column(u'botanycollection_accession', 'uqm_accession')

        # Deleting field 'Accession.unique_identifier'
        db.delete_column(u'botanycollection_accession', 'unique_identifier')
    ...
    models = {
        ...
        u'botanycollection.accession': {
            ...
            'uqm_accession': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '14', 'blank': 'True'}),
